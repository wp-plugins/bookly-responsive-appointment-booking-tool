...
class AB_Installer {
    ...
    public function __construct() {
        ...
        $this->options = array(
            ...
            'ab_appearance_text_info_second_step'     => __( "Below you can find list of available time slots for [[SERVICE_NAME]] by [[STAFF_NAME]].\nClick on a time slot to proceed with booking.", 'ab' ),
            'ab_appearance_text_info_third_step'      => __( "You selected to book [[SERVICE_NAME]] by [[STAFF_NAME]] at [[SERVICE_TIME]] on [[SERVICE_DATE]]. Price for the service is [[SERVICE_PRICE]].\nPlease provide your details in form below to proceed with booking.", 'ab' ),
            'ab_appearance_text_info_fourth_step'     => __( 'Please tell us how you would like to pay: ', 'ab' ),
            'ab_appearance_text_info_fifth_step'      => __( 'Thank you! Booking process is completed. An email with details of your booking has been sent to you.', 'ab' ),
            ...
            'ab_appearance_progress_tracker_type'     => 'Standard',
    ...
    private function _create_tables() {
        ...
        $wpdb->query(
            "CREATE TABLE IF NOT EXISTS ab_staff (
                ...
                google_user varchar(255) default '',
                google_pass varchar(255) default ''
            ) ENGINE = INNODB
