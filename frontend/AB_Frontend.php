...
class AB_Frontend {
    ...
    public function includeCSS() {
        ...
        echo '<style type="text/css">
                /* ==> Service */
                    ...
                    .pickadate__header {
                        border-bottom: 1px solid '. $booking_form_color .';
                    }
                    .pickadate__nav--next, .pickadate__nav--prev {
                        color: '. $booking_form_color .';
                    }
                    .pickadate__nav--next:before {
                        border-left:  6px solid '. $booking_form_color .';
                    }
                    .pickadate__nav--prev:before {
                        border-right: 6px solid '. $booking_form_color .';
                    }
                    ...
                    .ab-wrapper-content .ab-week-days li label.active {
                        background:    '. get_option( "ab_appearance_color" ) .' url(' .$checkbox_img. ') 0 0 no-repeat!important;
                    }
    ...
    public function includeJS() {
        ...
        wp_enqueue_script( 'ab-cookie', plugins_url( 'resources/js/jquery.cookie.js', __FILE__ ) );
        // Android animation
